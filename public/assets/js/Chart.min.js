   ...
   var s = o,
      ...
      u = {
         ...
         hexString: function (t, e) {
            ...
            return (
               '#' + v(t[0]) + v(t[1]) + v(t[2]) + (e >= 0 && e < 1 ? v(Math.round(255 * e)) : '')
            );
         },
      ...
      tooltips: {
         ...
         callbacks: {
            ...
            label: function (t, e) {
               var n = e.datasets[t.datasetIndex].label || '';
               return (
                  n && (n += ': '), H.isNullOrUndef(t.value) ? (n += t.yLabel) : (n += t.value), n
               );
            },
      ...
      'function' == typeof t
         ? {
              ...
              startOf: function (e, n, i) {
                 return (
                    (e = t(e)), 'isoWeek' === n ? e.isoWeekday(i).valueOf() : e.startOf(n).valueOf()
                 );
              },
              endOf: function (e, n) {
