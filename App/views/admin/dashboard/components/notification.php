      ...
      <div class="card card-lg mb-6">
         ...
         <div class="card-body px-6 py-8">
            <div class="d-flex align-items-center">
               ...
               <!-- text -->
               <div class="ms-4">
                  <h5 class="mb-1">Bắt đầu ngày mới với thông báo mới.</h5>
                  <p class="mb-0">
                     Bạn có
                     <a class="link-info" href="#!">2 thông báo mới</a>
                  </p>
               </div>
            </div>
         </div>
      ...
      <div class="card card-lg">
         ...
         <div class="card-body px-6 py-8">
            <div class="d-flex align-items-center">
               ...
               <!-- text -->
               <div class="ms-4">
                  <h5 class="mb-1">Giám sát doanh số và lợi nhuận của bạn</h5>
                  <p class="mb-0"><a class="link-info" href="#!">Xem hiệu xuất</a></p>
               </div>
            </div>
         </div>
      </div>
