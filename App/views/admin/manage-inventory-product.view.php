      ...
      <main class="main-content-wrapper">
         ...
         <div class="container">
            ...
            $breadcrumbs = [
               ...
               ['label' => 'Kho sản phẩm', "active" => true]
         
            ];

            $actionButton = '<a href="/admin/inventory-products/import" class="btn btn-primary">Nhập kho</a>';
            ...
            <!-- modal -->
            <?php
            $message = 'Bạn có muốn xoá kho sản phẩm này không ?';
